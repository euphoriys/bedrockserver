...
mkdir bedrockserver
cd ~/bedrockserver && wget https://www.minecraft.net/bedrockdedicatedserver/bin-linux/bedrock-server-1.21.30.03.zip && unzip bedrock-server*.zip && rm -rf bedrock-server*.zip && cd 
