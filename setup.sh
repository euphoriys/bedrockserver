...
mkdir bedrockserver
cd ~/bedrockserver && curl -A "Mozilla/5.0 (Linux; Android 10)" -o bedrock-server.zip https://www.minecraft.net/bedrockdedicatedserver/bin-linux/bedrock-server-1.21.51.02.zip && unzip bedrock-server*.zip && rm -rf bedrock-server.zip && cd 
